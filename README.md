...
library the size of Tau Ceti, memory grows as proofs are checked, faster with more threads or
processes, until the machine runs out: not understood yet, and the `term` check has not been run on
Tau Ceti to the end. On
